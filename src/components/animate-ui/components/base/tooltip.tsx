  ...
  return (
    <TooltipPortalPrimitive>
      <TooltipPositionerPrimitive sideOffset={sideOffset} className="z-50" {...props}>
        ...
        >
          {children}
          <TooltipArrowPrimitive className="bg-primary fill-primary z-50 size-2.5 data-[side='bottom']:-top-[4px] data-[side='right']:-start-[4px] data-[side='left']:-end-[4px] data-[side='inline-start']:-end-[4px] data-[side='inline-end']:-start-[4px] rotate-45 rounded-[2px]" />
        </TooltipPopupPrimitive>
